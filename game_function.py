...
def check_play_button(ai_settings,screen,stats,sb,play_button,ship,aliens,bullets,mouse_x,mouse_y):
	"""Start a new new when the player click play"""
...
def update_screen(ai_settings, screen, stats,sb,ship, aliens, bullets,play_button):
	#Draw the screen during each pass through the loop
		...
		ship.blitme() #for appearing the ship
		aliens.draw(screen)
...
def update_bullets(ai_settings,screen,sb,ship,stats,aliens,bullets):
	"""Update the position of the bullets and get rid of it"""
	...
	check_bullet_alien_collision(ai_settings,screen,sb,ship,stats,aliens,bullets)
...
def check_bullet_alien_collision(ai_settings,screen,sb,ship,stats,aliens,bullets):
...
def get_number_rows(ai_settings,ship_height,alien_height):
	"""Determine the number of rowsof aliens that fir on the screen"""
...
def check_fleet_edges(ai_settings,aliens):
	"""Respond appropiately if any alien has reaches edge"""
...
def check_aliens_bottom(ai_settings,stats,screen,sb,ship,aliens,bullets):
	"""Check any aliens have reached the bottom of the screen"""
